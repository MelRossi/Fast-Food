...
('Olivia García', 'Encargado de Turno', 'Administración', 1, 'Vendedor'), ('Ethan Martinez', 'Mesero', 'Restaurante', 1, 'Vendedor'),
...
SELECT COUNT(OrdenID) AS TotalOrdenes FROM Ordenes;

-- 2. ¿Cuántos empleados existen en cada departamento?
SELECT Departamento, COUNT(EmpleadoID) AS CantidadEmpleados
FROM Empleados
...
/* 5. ¿Cuáles son las sucursales con un promedio de Facturación/Ingresos superior a 1000.00 
